...
file_content = fileread('/media/human_face_need_test/brown_v2/all_get_sift_parameters_128.txt');
...
for e =1:1
    ...
    people_num=people{p_num};
        ...
        for cam = 1:16
            ...
            % detect pore  检测毛孔关键点
            [frames,descriptors] = func_detect_pore_no_looser_boundaries_128(im_crop,no_kpt, 1);
